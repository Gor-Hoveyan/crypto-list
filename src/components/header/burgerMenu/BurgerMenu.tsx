...
function BurgerMenu() {
    ...
    return (
        <nav className={isMenuOpened ? style.burgerMenuNav : style.hiddenBurgerMenuNav}>
            <ul className={isDarkMode ?  style.darkMenuList : style.lightMenuList}>
                <li><h1>Main</h1></li> {/* Create path to home page with react-router */}
                ...
                <li>
                    <p className={style.burgerMenuOpener}  onClick={() => handleBurgerMenu()}><MdOutlineMenu size='30px' color={isDarkMode ? 'white' : 'black'}/></p>
                </li> 
            </ul>
        </nav>
    )

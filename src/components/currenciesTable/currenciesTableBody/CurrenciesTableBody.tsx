        ...
        {isDataLoading ? data?.map((coin, index) => {
            return (
                <tr key={index}>
                    ...
                    <td className={Number(coin.changePercent24Hr) > 0 ? style.changePercentPositive : style.changePercentNegative}>{coin.changePercent24Hr ? slicePercent(coin.changePercent24Hr) : ''}%</td>
                </tr>
            );

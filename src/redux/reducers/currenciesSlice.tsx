    ...
    sortTable: (state, action: PayloadAction<string>) => {
      if (action.payload === "byHigherPrice") {
        state.data = state.data
          .sort(
            (firstCoin: CoinData, secondCoin: CoinData) =>
              Number(firstCoin.priceUsd) - Number(secondCoin.priceUsd)
          )
          .reverse();
        ...
        state.data = state.data.sort(
          (firstCoin: CoinData, secondCoin: CoinData) =>
            Number(firstCoin.rank) - Number(secondCoin.rank)
        );
        ...
        state.data = state.data.sort(
          (firstCoin: CoinData, secondCoin: CoinData) =>
            Number(firstCoin.marketCapUsd) - Number(secondCoin.marketCapUsd)
        );
        ...
        state.data = state.data
          .sort(
            (firstCoin: CoinData, secondCoin: CoinData) =>
              Number(firstCoin.volumeUsd24Hr) - Number(secondCoin.volumeUsd24Hr)
          )
          .reverse();
        ...
        state.data = state.data
          .sort(
            (firstCoin: CoinData, secondCoin: CoinData) =>
              Number(firstCoin.supply) - Number(secondCoin.supply)
          )
          .reverse();
        ...
        state.data = state.data
          .sort(
            (firstCoin: CoinData, secondCoin: CoinData) =>
              Number(firstCoin.vwap24Hr) - Number(secondCoin.vwap24Hr)
          )
          .reverse();
        ...
        state.data = state.data
          .sort(
            (firstCoin: CoinData, secondCoin: CoinData) =>
              Number(firstCoin.changePercent24Hr) -
              Number(secondCoin.changePercent24Hr)
          )
          .reverse();
        ...
        state.data = state.data
          .sort((firstCoin: CoinData, secondCoin: CoinData) =>
